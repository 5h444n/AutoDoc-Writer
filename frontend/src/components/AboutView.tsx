    ...
    return (
        <div className="flex flex-col items-center justify-center h-full animate-in fade-in duration-500 content-center justify-items-center">
            <GlassCard className="max-w-lg w-full text-center relative p-8">
                ...
                <div className="h-16 w-16 bg-blue-600 rounded-xl mx-auto flex items-center justify-center mb-6 shadow-lg shadow-blue-500/30">
                ...
                <div className="space-y-4 text-left bg-slate-900/50 p-6 rounded-xl border border-white/5">
